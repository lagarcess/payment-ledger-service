...
description: |
  The marketing surfaces pair a stark black canvas with the brand's
...
The marketing canvas operates in a high-contrast two-mode system: a
...
using our app") sits at 80–136px with `lineHeight: 1.0` and tight negative
...
| `{typography.display-xl}` | 80px | 500 | 1.0 | -0.8px | Section openers ("Join the 70+ million using our app"). |
